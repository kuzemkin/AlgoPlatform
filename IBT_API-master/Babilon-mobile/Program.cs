...
namespace Babilon_mobile
{
    class Program
    {
        ...
        {
            Requests.GetRate("5058270374080470").RespInfo();
            ...
            //Requests.Payment("901117077", DateTime.Now.Ticks,100,99,1, "2021881", "9802CEBC-67AA-41EA-8F1F-50DF8B31A099").ResponseInfo();            
            Console.ReadKey();            
        }
    }
}
